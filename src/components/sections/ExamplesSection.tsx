...
export const ExamplesSection = () => {
  return (
    <div className="flex min-h-0 w-full items-center justify-center md:min-h-screen bg-dark-bg">
      <div className="mx-auto w-full max-w-screen-xl px-8 py-16">
        <section className="flex flex-col items-center">
          ...
          <section className="grid grid-cols-1 gap-8 py-10 md:grid-cols-2">
            <a href="https://app.undermind.ai/report/b3767fb7b65e9a7e90273d02558b2cc376258d1b9e58376f0b7c0924b85f694a/" target="_blank">
            ...
            <a href="https://app.undermind.ai/report/c87c6d79747cdbb877bdbc0ce840c86c21a3f9adbeade7c7a08f33d54b8ad01c/" target="_blank">
              <div className="flex flex-col gap-2">
            ...
            <a href="https://app.undermind.ai/report/66b70a0fa6b78d00d94aeb0788b30925f90b801022ccb433317f933c9390891d/" target="_blank">
              <div className="flex flex-col gap-2">
            ...
            <a href="https://app.undermind.ai/report/0484b7604bc82e77a2d88c729b0808b5791ca14f61e6c37db00c35428d0ec232/" target="_blank">
              <div className="flex flex-col gap-2">
            ...
            <a href="https://app.undermind.ai/report/c53d4f34e990e057c729d7cb34d97ba0c70aeae524fd9ca7a66c3807a3f37c10/" target="_blank">
              <div className="flex flex-col gap-2">
            ...
            <a href="https://app.undermind.ai/report/c5f77f862ae783b7738e9931db42a8590b5567af4ba9759e1d4b7ca5b65dc9f5/" target="_blank">
              <div className="flex flex-col gap-2">
